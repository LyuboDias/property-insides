  ...
  return (
    <>
      ...
      <div className="main-content" style={{ flex: 1, padding: '40px 0', display: 'flex', flexDirection: 'column', alignItems: 'center', color: '#000' }}>
        ...
        <div style={{ width: '100%', maxWidth: 1200, background: 'rgba(255,255,255,0.95)', backdropFilter: 'blur(10px)', borderRadius: 16, boxShadow: '0 8px 30px rgba(0,0,0,0.12)', padding: 32, marginBottom: 24, color: '#000', border: '1px solid rgba(255,255,255,0.2)' }}>
